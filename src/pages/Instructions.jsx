  ...
  return (
    <section className="section-instruction">
      ...
      <p className="paragraph-instructions-mobile">
        ...
        <br></br>
        <br></br>Une fois l'audio du rire terminé, imitez-le du mieux que vous
        le pouvez. Laissez votre rire être authentique et spontané, sans vous
        inquiéter de son apparence ou de sa sonorité.
        <br></br>
        <br></br>
        ...
        respirer, puis préparez-vous à répéter le processus. Continuez à suivre
        les instructions et à rire avec abandon.
      </p>
      ...
      <p className="paragraph-instructions-mobile">
        ...
        pour commencer.
        <br></br>
        <br></br>La personne désignée doit faire le rire qu’il veut en appuyant
        sur le bouton de l'application.
        <br></br>
        <br></br>Une fois que le rire initial est déclenché, les autres
        participants doivent imiter le rire à leur tour.
        <br></br>
        ...
        <br></br>
        <br></br>A la fin de la séance, prenez le temps de vous remercier pour
        ce moment ensemble en vous regardant droit dans les yeux
      </p>
      <p className="sample-sound">Exemple :</p>
      <audio controls src={a_vos_rire}></audio>
      <button className="button-instructions" onClick={handleReturn}>
        Retour
      </button>
    </section>
  );
